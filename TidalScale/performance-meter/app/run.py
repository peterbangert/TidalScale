...
import fileinput
from src.performance_meter import PerformanceMeter
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clear', action='store_true', help='Clear postgresql Table')
    ...
    metric_reporter = PerformanceMeter(args)
    metric_reporter.run()
