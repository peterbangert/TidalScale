...
from src.model.kafka_producer import KafkaProducer
from src.model.pubsub_publisher import PubSubPublisher
...
class TrafficGenerator:
    ...
    def __init__(self,args):
        ...
        self.args = args
        if args.pubsub or config.broker == 'pubsub':
            self.producer = PubSubPublisher(args)
        else:
